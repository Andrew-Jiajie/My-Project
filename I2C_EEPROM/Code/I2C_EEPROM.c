...
#define LED                     P3
//#define PAGE_SIZE               32       //24C64, weifeng del
//#define PAGE_NUMBER             4        //24C64, weifeng del
#define PAGE_SIZE               8          //24C02, weifeng modify
#define PAGE_NUMBER             32         //24C02, weifeng modify
